...
export function createDebateStudioApi(ipcRenderer: IpcRendererLike): DebateStudioApi {
  return {
    ...
    openDownloadedApplicationUpdate: () => invoke(ipcRenderer, IPC_CHANNELS.openDownloadedApplicationUpdate),
    deleteDownloadedApplicationUpdate: () => invoke(ipcRenderer, IPC_CHANNELS.deleteDownloadedApplicationUpdate),
    showDownloadedUpdateInFinder: () => invoke(ipcRenderer, IPC_CHANNELS.showDownloadedUpdateInFinder),
    openLatestRelease: () => invoke(ipcRenderer, IPC_CHANNELS.openLatestRelease),
    clearApplicationUpdateCache: () => invoke(ipcRenderer, IPC_CHANNELS.clearApplicationUpdateCache),
