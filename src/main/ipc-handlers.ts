...
export function registerDebateIpc(dependencies: DebateIpcDependencies): () => void {
  ...
  ipcMain.handle(IPC_CHANNELS.openDownloadedApplicationUpdate, () => dependencies.updates?.openDownloadedUpdate() ?? updateUnavailable())
  ipcMain.handle(IPC_CHANNELS.deleteDownloadedApplicationUpdate, () => dependencies.updates?.deleteDownloadedUpdate() ?? updateUnavailable())
