...
describe('preload DebateStudioApi', () => {
  it('exposes only the explicit method whitelist', () => {
    ...
    expect(Object.keys(api).sort()).toEqual([
      ...
      'pauseDebate', 'planDebate', 'publishResearchEvidence', 'regenerateDebateQuality', 'regenerateLanPassword', 'removeTag', 'renameDebate', 'reopenOnboarding', 'reportRendererError', 'reportRendererPerformance', 'restoreDatabaseBackup', 'restoreDebate', 'resumeDebate', 'retryFailedTurn', 'revealLanPassword', 'rollbackPromptVersion', 'runMockSearch', 'saveCredential', 'saveModelProfile', 'saveModelRoutingPolicy', 'saveOnboardingDefaults', 'saveOnboardingProvider',
      ...
      'setLanPassword', 'skipDebate', 'skipOnboarding', 'startDebate', 'startLanServer', 'stopDebate', 'stopLanServer', 'testConnection', 'testOnboardingConnection', 'testSearchConnection', 'toggleFavorite', 'updateEvidenceStatus', 'updateLanServerConfig'
    ].sort())
