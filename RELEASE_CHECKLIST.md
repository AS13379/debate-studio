# Debate Studio 0.2.4 macOS Release Checklist

当前版本为 `0.2.4`，bundle identifier 为 `com.leander.debatestudio`。

## 发布策略

- 0.2.4 作为个人/社区维护的本地 macOS 应用发布。
...
`release/Debate-Studio-0.2.4-arm64.dmg`
...
- 将 `release/Debate-Studio-0.2.4-arm64.dmg` 作为附件上传；不要提交 `release/` 目录。
